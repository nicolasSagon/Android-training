...
fun SportsApp(
    ...
    val sportsContentType = getSportsContentType(windowSize)
    ...
    Scaffold(
        ...
        if (sportsContentType == SportsContentType.ListOnly) {
...
fun SportsAppBar(
    ...
    TopAppBar(
        ...
        navigationIcon = if (!isShowingListPage && sportsContentType == SportsContentType.ListOnly) {
            {
...
@Composable
private fun SportListAndDetails(
    sports: List<Sport>,
    selectedSport: Sport,
    onClick: (Sport) -> Unit,
    modifier: Modifier = Modifier,
    ...
    Row(modifier = modifier) {
        SportsList(sports = sports, onClick = onClick, modifier = Modifier.weight(0.4F))
        SportsDetail(
...
fun getSportsContentType(windowSize: WindowSizeClass): SportsContentType {
